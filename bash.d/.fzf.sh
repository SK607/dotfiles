...
# DEFAULTS
export FZF_DEFAULT_OPTS='--color=bg+:#3a3a3a,bg:#3a3a3a,spinner:#fb4934,hl:#928374,fg:#ebdbb2,header:#928374,info:#8ec07c,pointer:#fb4934,marker:#fb4934,fg+:#ebdbb2,prompt:#fb4934,hl+:#fb4934 --bind up:preview-up,down:preview-down'
